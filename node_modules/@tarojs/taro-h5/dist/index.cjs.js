...
function usePageLifecycle(callback, lifecycle) {
  ...
  if (!hook.marked) {
    hook.marked = true;
    var originalLifecycle = hook.component[lifecycle];

    hook.component[lifecycle] = function () {
      originalLifecycle && originalLifecycle.call.apply(originalLifecycle, [hook.component].concat(Array.prototype.slice.call(arguments)));
